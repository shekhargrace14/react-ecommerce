...
const Collections = () => {
  return (
    <div className='bg-[url("/images/collection-bg.png")] bg-cover bg-cover bg-center bg-no-repeat xl:px-28 px-4 my-20'>
        <div className='h-[580px] flex justify-between  md:flex-row items-center'>
            ...
            <div className='md:w-1/2'>
                ...
                <button className='px-6 py-2 bg-white text-black rounded-sm font-sans-semibold'>See Collection</button>
            </div>
        </div>
    </div>
  )
