...
const Category = () => {
  return (
    <div className='max-w-screen-2xl mx-auto container xl:px-28 sc:px-8 sc:py-28 ' >
        {/* brands logos  */}
        ...
        <div className='mt-8 flex flex-col md:flex-row items-center gap-2 '>
          <p className='font-semibold uppercase md:-rotate-90 text-center bg-black text-white md:px-4 p-2 rounded-sm inline-flex'>Explore new and popular styles</p>
          <div>
